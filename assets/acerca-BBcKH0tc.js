import{n as e,t}from"./wii-DZzdzbZC.js";import{U as n}from"./widev-DCNhLI3Q.js";import{a as r}from"./index-CSOg0w4I.js";/* empty css               */var i=()=>`
<main id="wimain">
<div class="ac_wrap">
  ...
  <section class="ac_hero">
    ...
    <div class="ac_hero_body">
      <div class="ac_hero_logo" style="border:none; border-radius: 20px;">
        <img src="/smile.avif" alt="${t}" loading="lazy" style="border-radius:20px;">
      </div>
  ...
  <section class="ac_sec">
    <div class="ac_sec_head">
      ...
      <h2 class="ac_sec_tit">Por qué <span class="ac_grad">${t}</span></h2>
    </div>
    <div class="ac_historia wi_fadeUp">
      <p><strong>${t}</strong> nace para que ninguna fecha especial se pierda entre el trabajo, los mensajes y la prisa diaria. Guardas cumpleaños, relación, notas, ideas de regalo, foto y color; la app te ayuda a recordar con tiempo y con cariño.</p>
      ...
      <div class="ac_firma">
        <strong>Con cariño, ${e}</strong>
        <span>Diseño y Desarrollo · ${t}</span>
      </div>
    </div>
  </section>
  ...
  <section class="ac_sec ac_sec_alt">
    <div class="ac_sec_head">
      ...
      <p class="ac_sec_sub">Testimonios reales sobre cómo ${t} ha facilitado sus vidas</p>
    </div>
  ...
  <section class="ac_sec">
    <div class="ac_sec_head">
      ...
      <h2 class="ac_sec_tit">Explora más <span class="ac_grad">de ${t}</span></h2>
...
`,a=[],o=(e,t,n)=>{let r=e=>{if(!t){n.call(e.currentTarget,e);return}let r=e.target.closest(t);r&&n.call(r,e)};document.addEventListener(e,r),a.push({type:e,wrapper:r})},s=()=>{a.forEach(({type:e,wrapper:t})=>{document.removeEventListener(e,t)}),a.length=0},c=()=>{let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`visible`)})},{threshold:.1});document.querySelectorAll(`.wi_fadeUp`).forEach(t=>{e.observe(t)}),o(`click`,`#ac_compartir`,function(e){let r=window.location.origin;navigator.share?navigator.share({title:t,text:`🎉 Organiza tus cumpleaños y celebraciones de forma veloz, segura y premium con ${t}. ¡Pruébalo!`,url:r}).catch(()=>{}):n(r,this,`¡Link copiado!`)}),o(`click`,`.nv_item`,function(e){let t=this.getAttribute(`href`);t&&t.startsWith(`/`)&&(e.preventDefault(),r(()=>import(`./index-CSOg0w4I.js`).then(e=>e.i).then(e=>e.rutas.navigate(t)),[]))}),window.wiInitTips&&window.wiInitTips(),console.log(`🛡️ ${t} Acerca actualizado`),window.__WIREADY__=!0},l=()=>{s()};export{l as cleanup,c as init,i as render};