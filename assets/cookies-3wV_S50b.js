...
<div class="ac_wrap tm_wrap">
  <section class="ac_hero tm_hero">
    ...
    <div class="ac_hero_body">
      ...
      <p class="ac_hero_sub">Te explicamos cómo usamos el almacenamiento local y la caché técnica de tu dispositivo para garantizar el funcionamiento rápido de <strong>${e}</strong>.</p>
      ...
      <div class="tm_last_upd"><i class="fas fa-calendar-check"></i> Última actualización: ${t()} · Versión v10</div>
    </div>
  </section>
...
</div></main>`,o=[],s=(e,t,n)=>{let r=e=>{if(!t){n.call(e.currentTarget,e);return}let r=e.target.closest(t);r&&n.call(r,e)};document.addEventListener(e,r),o.push({type:e,wrapper:r})},c=()=>{o.forEach(({type:e,wrapper:t})=>{document.removeEventListener(e,t)}),o.length=0},l=null,u=()=>{l=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`visible`)}),{threshold:.1}),document.querySelectorAll(`.wi_fadeUp`).forEach(e=>{l.observe(e)}),s(`click`,`.tm_nav`,function(e){e.preventDefault(),n(()=>import(`./index-CSOg0w4I.js`).then(e=>e.i).then(e=>e.rutas.navigate(this.getAttribute(`href`))),[])}),console.log(`🍪 ${e} Cookies cargada`),window.__WIREADY__=!0},d=()=>{l?.disconnect?.(),l=null,c()};export{d as cleanup,u as init,a as render};