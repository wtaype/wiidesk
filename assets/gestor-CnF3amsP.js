import{t as e}from"./wii-DZzdzbZC.js";import{O as t,b as n}from"./widev-DCNhLI3Q.js";import{r}from"./index-BmuCDrV3.js";var i=()=>n(`wiSmile`)||null,a=()=>{let e=i();if(!e)return location.replace(`/`),``;let t=e.nombre||e.usuario||`Gestor`,r=n(`wi_editor_posts_${e.usuario.trim().toLowerCase()}`)||[],a=e.rol===`admin`?`Administrador`:`Gestor de Contenido`;return`
