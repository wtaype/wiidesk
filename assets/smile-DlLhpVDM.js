import{t as e}from"./wii-DZzdzbZC.js";import{b as t}from"./widev-DCNhLI3Q.js";import{r as n}from"./index-BBkUU4ZD.js";var r=()=>t(`wiSmile`)||null,i=()=>{let t=r();return t?`
    <div class="smw_dash" style="padding: 4vh; color: var(--tx1);">
      <header class="smw_hero" style="position:relative; margin-bottom: 4vh;">
        <h1 style="font-size: 2.5rem; font-weight: 800; color: var(--tx1); margin-bottom:1vh;">¡Hola, ${t.nombre||t.usuario||`amigo`}!</h1>
        <p style="color: var(--tx3); font-size: var(--fz_m1);">Consola de Control de Equipos de ${e}</p>
      </header>
  ...
  `:(location.replace(`/`),``)},a=e=>{let t=e.target.closest(`.nv_item`);t&&t.getAttribute(`data-page`)&&(e.preventDefault(),n.navigate(`/`+t.getAttribute(`data-page`)))},o=async()=>{if(!r())return setTimeout(()=>n.navigate(`/login`),100);document.addEventListener(`click`,a),console.log(`🏜️ Dashboard de ${e} cargado.`),window.__WIREADY__=!0},s=()=>{document.removeEventListener(`click`,a)};export{s as cleanup,o as init,i as render};