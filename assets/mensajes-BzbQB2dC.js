import{t as e}from"./wii-DZzdzbZC.js";import{U as t,V as n,b as r,o as i}from"./widev-DCNhLI3Q.js";import{r as a}from"./index-BBkUU4ZD.js";import{_ as o,b as s,d as c,g as l,m as u,o as d,r as f,s as p,u as m}from"./firebase-DqjnRvzz.js";import{n as h,t as g}from"./firebase-BtK1IiLA.js";var _=[],v=null,y=!1,b=null,x=null,S=`wi_mensajes_cache`,C=50,w=()=>r(`wiSmile`)||{},T=e=>{try{localStorage.setItem(S,JSON.stringify(e))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(S)||`[]`)}catch{return[]}},D=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},O=()=>{let t=w();return t.email?`
