import{t as e}from"./wii-DZzdzbZC.js";import{O as t}from"./widev-DCNhLI3Q.js";import{r as n}from"./index-BBkUU4ZD.js";var r=()=>`
<div class="dc_wrap">
  <div class="dc_hero" data-showi="80">
    <div class="dc_badge"><i class="fas fa-compass"></i> Descubre ${e}</div>
...
`,i=e=>{let t=e.target.closest(`.nv_item`);if(t){let r=t.getAttribute(`href`);r&&r.startsWith(`/`)&&(e.preventDefault(),n.navigate(r))}},a=()=>{t(`[data-showi]`),document.addEventListener(`click`,i),console.log(`🧭 ${e} Descubre cargado`),window.__WIREADY__=!0},o=()=>{document.removeEventListener(`click`,i)};export{o as cleanup,a as init,r as render};