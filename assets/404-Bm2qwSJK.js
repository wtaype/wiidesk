var e=async()=>`
  ...
  `,t=()=>{if(!document.getElementById(`wi404-styles`)){let e=document.createElement(`style`);e.id=`wi404-styles`,e.textContent=`
...
@keyframes glitch{0%,100%{transform:translate(0)}25%{transform:translate(-2px,2px)}75%{transform:translate(2px,-2px)}}
    `,document.head.appendChild(e)}let e=document.querySelector(`.wi404_btn`);e&&e.addEventListener(`click`,()=>location.href=`/`)};export{t as init,e as render};