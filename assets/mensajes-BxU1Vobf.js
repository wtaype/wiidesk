import{t as e}from"./wii-DZzdzbZC.js";import{U as t,V as n,b as r,o as i}from"./widev-DCNhLI3Q.js";import{r as a}from"./index-BmuCDrV3.js";import{a as o,g as s,h as c,l,n as u,o as d,p as f,u as p,y as m}from"./firebase-HsegvofM.js";import{n as h,t as g}from"./firebase-Bl23Hk2a.js";var _=[],v=null,y=!1,b=null,x=null,S=`wi_mensajes_cache`,C=50,w=()=>r(`wiSmile`)||{},T=e=>{try{localStorage.setItem(S,JSON.stringify(e))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(S)||`[]`)}catch{return[]}},D=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},O=()=>{let t=w();return t.email?`
