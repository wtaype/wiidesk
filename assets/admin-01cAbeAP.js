import{n as e,s as t,t as n}from"./wii-DZzdzbZC.js";import{E as r,b as i,o as a,s as o}from"./widev-DCNhLI3Q.js";import{h as s,l as c,p as l,r as u}from"./firebase-HsegvofM.js";import{n as d}from"./firebase-Bl23Hk2a.js";var f=()=>i(`wiSmile`),p=`am_users`,m=`am_activos`,h=`am_devices`,g=`am_blog`,_=`am_chat`,v=`am_plan_free`,y=`am_plan_pro`,b=`am_plan_vip`,x=`am_rol_usuario`,S=`am_rol_editor`,C=`am_rol_gestor`,w=`am_rol_admin`,T=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)},E=(e,t,n)=>{let r=document.getElementById(e);r&&r.style.setProperty(t,n)},D=()=>{let r=f();return!r||r.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
